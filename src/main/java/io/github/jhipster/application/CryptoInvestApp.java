...
public class CryptoInvestApp {

    private static final Logger log = LoggerFactory.getLogger(CryptoInvestApp.class);

    private final Environment env;

    public CryptoInvestApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes CryptoInvest.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CryptoInvestApp.class);
